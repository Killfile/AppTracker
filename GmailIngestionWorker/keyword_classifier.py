...
class KeywordClassifier:
    ...
    def is_blacklisted(self, subject: str, body: str, sender: str) -> bool:
        ...
        for pattern in subject_blacklist:
    ...
    def is_application_related(self, subject: str, body: str, sender: str) -> KeywordClassifications:
        ...
        if any(re.search(pattern, subject) for pattern in subject_patterns):
            return KeywordClassifications.HIT
        if any(re.search(pattern, body) for pattern in body_patterns):
            return KeywordClassifications.HIT
        if any(re.search(pattern, sender) for pattern in sender_patterns):
            return KeywordClassifications.HIT
